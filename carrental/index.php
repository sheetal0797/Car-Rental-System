...
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/images/logo.html">
      ...
      <div class="row">
        <div class="col-md-8 col-md-push-5">
          <div class="banner_content">
            <h1>The Car You Desire, Delivered.</h1>
            <p>Leasing a car has never been easier.You find the perfect car we'll find the best financing and deliver to your door.</p>
			<?php   if(strlen($_SESSION['login'])==0)
	{	
?>
 <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal"><h4>Login / Register</h4></a> </div>
<?php 
 } ?>
            </div>
        </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find and Lease Your Next Vehicle</h2>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">LEASE YOUR CAR</a></li>
        </ul>
      </div>
